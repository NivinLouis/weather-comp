...
export default function WeatherCompass() {
  ...
  const handleAnalyze = async () => {
    ...
    try {
      ...
      analysisResult.locationName = coords.name;
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-slate-400 text-sm">
                Forecast event suitability using historical patterns
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        <div className="grid lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-1">
            <div className="bg-slate-900/50 backdrop-blur-xl rounded-2xl shadow-2xl border border-slate-700/50 p-6 space-y-6 sticky top-4">
              <div ref={suggestionsRef} className="relative">
                ...
                {showSuggestions &&
                  (locationSuggestions.length > 0 || loadingSuggestions) && (
          ...
          <div className="lg:col-span-2">
            ...
            {!analysis && !loading && !error && (
              <div className="bg-slate-900/50 backdrop-blur-xl rounded-2xl shadow-2xl border border-slate-700/50 p-12 text-center">
                ...
                <p className="text-slate-400">
                  Configure your event details and click "Analyze Weather" to
                  generate a report
                </p>
              </div>
            )}
            ...
            {analysis && (
              <div className="space-y-6">
                {/* Header */}
                <div className="bg-slate-900/50 backdrop-blur-xl rounded-2xl shadow-2xl border border-slate-700/50 p-6">
      ...
      {/* Footer */}
      <div className="bg-slate-900/50 backdrop-blur-xl border-t border-slate-700/50 mt-12 py-6">
